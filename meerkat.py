...
class Gdeb(Gtk.FileChooserDialog):
    ...
    def make(self, DesktopCheckButton):
        ...
        TurkishChrControl = self.PackageEntry.get_text() + self.DesktopIconDict[self.DesktopIconComboBoxText.get_text()]['png'] + self.MainComboBoxText.get_text()
        for ch in ["ö","ı","ç","ş","ü", "Ö", "I", "Ş", "Ç", "Ü"]:
            if TurkishChrControl.find(ch) is not -1:
                self.message()
                break
    ...
    def __init__(self, BetaApp):
        ...
        self.MeerkatButton = Gtk.ToggleButton('Meerkat')
        #self.MeerkatButton.set_active(0)
        self.MeerkatButton.connect('clicked', self.yardim)
        self.Headerbar.pack_start(self.MeerkatButton)
        ...
        self.DesktopProjeLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("black"))
        ...
        self.PackageLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("black"))
        self.PackageEntry = Gtk.Entry()
        self.PackageEntry.set_width_chars(23)
        ...
        self.ExceLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("gray"))
        self.ExceComboBoxText = Gtk.ComboBoxText()
        self.ExceComboBoxText.insert(0, "0", "Python"+' '*30)
        ...
        self.MainLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("gray"))
        ...
        self.DesktopIconLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("gray"))
        ...
        self.Hbox = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=1)
        #self.BoxRow.add(self.Hbox)
        #self.DesktopIconLabelWarning = Gtk.Label("", xalign=0)
        #self.DesktopIconComboBoxTextWarning = Gtk.Label("Simge Maksimum 64x64" + " "*10 + "\nolmalı")
        ...
        self.VersionLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("gray"))
        self.VersionEntry = Gtk.Entry()
        self.VersionEntry.set_width_chars(23)
        ...
        self.CategoriesLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("gray"))
        ...
        self.CategoriesComboBoxText.insert(7, "7", "Development"+' '*19)
        ...
        self.SectionLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("gray"))
        self.SectionEntry = Gtk.Entry()
        self.SectionEntry.set_width_chars(23)
        ...
        self.PriorityLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("gray"))
        self.PriorityEntry = Gtk.Entry()
        self.PriorityEntry.set_width_chars(23)
        ...
        self.ContactLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("gray"))
        self.ContactEntry = Gtk.Entry()
        self.ContactEntry.set_width_chars(23)
        ...
        self.DescriptionLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("gray"))
        self.ContactLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("gray"))
        self.DescriptionEntry = Gtk.Entry()
        self.DescriptionEntry.set_width_chars(23)
        ...
        self.Hbox = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=50)
        self.BoxRow.add(self.Hbox)
        self.CpuLabel = Gtk.Label("İslemci", xalign=0)
        self.CpuLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("gray"))
        self.CpuEntry = Gtk.ComboBoxText()
        self.CpuEntry.insert(0, "0", "i386")
        self.CpuEntry.insert(1, "1", "amd64")
        ...
        self.Hbox = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=50)
        self.BoxRow.add(self.Hbox)
        self.DesktopLabel = Gtk.Label("Uygulamalar Klasörüne Kaydet", xalign=0)
        self.DesktopLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("gray"))
        ...
        self.Hbox = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=10)
        self.BoxRow.add(self.Hbox)
        self.DesktopLabel = Gtk.Label("Kurulabilir Paket Dosya", xalign=0)
        self.DesktopLabel.modify_fg(Gtk.StateFlags.NORMAL, Gdk.color_parse("gray"))
    ...
    def on_folder_clicked(self, widget):
        ...
        if response == Gtk.ResponseType.OK:
            self.MeerkatButton.set_active(1)
    ...
    def message(self):
        dialog = Gtk.MessageDialog(None, 0, Gtk.MessageType.INFO,
            Gtk.ButtonsType.OK, "")
        dialog.format_secondary_text(
            "Proje dosya ve klasörlerde türkçe karekter ve boşluk kullanılmamalı!")
        dialog.run()
        dialog.destroy()
